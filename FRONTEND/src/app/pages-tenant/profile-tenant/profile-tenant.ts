...
@Component({
  selector: 'app-profile-tenant-dialog',
  standalone: true,
  templateUrl: './profile-tenant.html',
  styleUrls: ['./profile-tenant.css'],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    MatDialogModule,
...
export class ProfileTenant implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ProfileTenant>,
